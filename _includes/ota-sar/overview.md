...
{% if sar_profile.onboarding_notice != "" %}
> {{ sar_profile.onboarding_notice }}
{% endif %}
...
|                  | Test                                            |
|------------------|-------------------------------------------------|
| Auth API         | {{ sar_profile.test_auth_origin }}/auth          |
| OTA API          | {{ sar_profile.test_api_origin }}/ota/v2015b/OTA |
| REST API         | {{ sar_profile.test_api_origin }}/{service-name} |
...
|                  | Production                                            |
|------------------|-------------------------------------------------------|
| Auth API         | {{ sar_profile.production_origin }}/auth                |
| OTA API          | {{ sar_profile.production_origin }}/ota/v2015b/OTA      |
| REST API         | {{ sar_profile.production_origin }}/{service-name}      |
...
|                   | Production                             | Test                                   |
| ----------------- | -------------------------------------- | -------------------------------------- |
| Identity Provider | {{ sar_profile.production_origin }}/auth | {{ sar_profile.test_auth_origin }}/auth |
...
| password      | User password                       | {{ sar_profile.password_example }} |
...
<details>
  ...
  <pre>
    ...
    -d 'grant_type=password&client_id={{ sar_profile.client_id_example }}&client_secret={client_secret}&username={username}&password={password}'
  </pre>

  <h4>Response</h4>
  <pre>
    {
      "access_token": "{{ sar_profile.access_token_example }}",
      "expires_in": 7200,
...
# Postman Collection
[Download Postman Collection]({{ sar_profile.postman_download }})
...
|                  | Production                                            | Test                                     |
| ---------------- | ----------------------------------------------------- | ---------------------------------------- |
| Routes & Flights | {{ sar_profile.production_origin }}/sms-gateway-service | {{ sar_profile.test_gateway_origin }}/sms-gateway |
...
|         | Production                                       | Test                                            |
| ------- | ------------------------------------------------ | ----------------------------------------------- |
| OTA API | {{ sar_profile.production_origin }}/ota/v2015b/OTA | {{ sar_profile.test_api_origin }}/ota/v2015b/OTA |
