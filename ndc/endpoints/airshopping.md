...
`POST` `https://go7-api-gateway.prod.go7.io/ndc-gateway/v21.3.5/AirShopping`
...
=== "Curl"
    ...
    ```bash
    curl -X POST https://go7-api-gateway.prod.go7.io/ndc-gateway/v21.3.5/AirShopping \
      -H "x-tenant: tenant-a" \
